  ...
  return (
    <section className="section">
      <div className="container legal">
        ...
        <ul>
          <li><strong>Account details:</strong> when you sign up, our authentication provider collects your email address and either a password or your Google sign-in, plus a display name if you provide one.</li>
          ...
          <li><strong>Payment data:</strong> if you subscribe to Pro, your card details are collected and held by our payment provider. We never see or store your card number, only your subscription status.</li>
        ...
        <p>
          To build your quiz, the material you upload is sent to our AI provider, which reads
        ...
        <p>
          ...
          provider, and only the resulting text is used to generate your quiz. Larger
          uploads on the Pro plan, including audio and video, pass through a temporary file store
          that we delete as soon as the file has been forwarded for processing. Sets
        ...
        <p>
          These providers process your content only to provide these features, under their
        ...
        <ul>
          <li>Our <strong>authentication provider</strong>, for accounts and sign-in.</li>
          <li>Our <strong>database and hosting providers</strong>, which store your study data, plan and usage counters and shared quizzes, and run the service (including the temporary file transfer described above).</li>
          <li>Our <strong>AI provider</strong>, which generates your quizzes from your material and runs the content safety check.</li>
          <li>Our <strong>transcription provider</strong>, for the audio and video you upload.</li>
          <li>Our <strong>payment provider</strong>, for Pro subscriptions.</li>
          <li>Our <strong>advertising provider</strong>, for ads on the Free plan (see section 5).</li>
          <li>Our <strong>email provider</strong>, for delivering your contact-form messages to our support inbox.</li>
        </ul>
        <p>
          A current list of the specific companies acting as our processors is available on
          request at <a href="mailto:support@revyy.app">support@revyy.app</a>.
        </p>
